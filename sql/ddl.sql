-- 创建库
create database if not exists project_qi_api;

-- 切换库
use project_qi_api;

-- 用户表
create table if not exists project_qi_api.user
(
...
-- 每日签到表
create table if not exists project_qi_api.daily_check_in
(
    id          bigint auto_increment comment 'id' primary key,
...
-- 接口信息
create table if not exists project_qi_api.interface_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 产品信息
create table if not exists project_qi_api.product_info
(
    id             bigint auto_increment comment 'id' primary key,
...
# 产品订单
create table if not exists project_qi_api.product_order
(
    id             bigint auto_increment comment 'id' primary key,
...
#付款信息
create table if not exists project_qi_api.payment_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 用户接口调用表
create table if not exists project_qi_api.user_interface_invoke
(
    id           bigint auto_increment comment 'id' primary key,
...
-- 充值活动表
create table if not exists project_qi_api.recharge_activity
(
    id         bigint auto_increment comment 'id' primary key,
